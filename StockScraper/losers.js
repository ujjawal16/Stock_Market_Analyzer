...
function extractLink(html){
    ...
    for(let j=0;j<table.length;j++)
    {
        ...
        processLosers(descEl,symbol,name,price,change,percentageChange,marketCap,volume);
    }
            
}

function processLosers(title,symbol,name,price,change,percentageChange,marketCap,volume)
{
