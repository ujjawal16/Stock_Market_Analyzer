...
function extractLink(html){
    ...
    //console.log(html);
    let descEl="Highest-Implied-Volatility"; 
    console.log(descEl);
    ...
    for(let j=0;j<table.length;j++)
    {
        ...
        processIV(descEl,symbol,name,strike,expDate,price,change,percentageChange,volume);
    }
            
}

function processIV(title,symbol,name,strike,expDate,price,change,percentageChange,volume)
{
