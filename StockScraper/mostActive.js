...
function extractLink(html){
    ...
    for(let j=0;j<table.length;j++)
    {
        ...
        processMostActive(descEl,symbol,name,price,change,percentageChange,marketCap,volume);
    }
            
}

function processMostActive(title,symbol,name,price,change,percentageChange,marketCap,volume)
{
