...
function extractLink(html){
    ...
    for(let j=0;j<table.length;j++)
    {
        ...
        processCurrencies(descEl,symbol,name,lastPrice,change,percentageChange);
    }
            
}

function processCurrencies(title,symbol,name,price,change,percentageChange)
{
